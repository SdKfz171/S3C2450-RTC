...
#define rTICNT0    (*(volatile unsigned char *)0x57000044)	//Tick time count 0 
#define rTICNT2    (*(volatile unsigned char *)0x57000048)	//Tick time count 2
#define rTICNT1    (*(volatile unsigned char *)0x5700004C)	//Tick time count 1
